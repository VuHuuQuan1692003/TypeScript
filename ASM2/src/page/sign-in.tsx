                    ...
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        <form action="#" className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="col-span-6">
                                ...
                                <input
                                    {...register('email')}
                                    className="mt-1 w-full border rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                                />
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                ...
                                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                                    ...
                                    <a href="#" className="text-gray-700 underline">Create account</a>.
                                </p>
                            </div>
                        </form>
                    </div>
